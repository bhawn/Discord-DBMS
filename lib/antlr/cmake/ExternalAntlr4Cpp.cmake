...
#Not sure if i need to change this next line
...
set(ANTLR4CPP_LOCAL_ROOT ${CMAKE_BINARY_DIR}/lib/antlr/locals/antlr4cpp)
SET(ANTLR4CPP_LOCAL_REPO ${PROJECT_SOURCE_DIR}/lib/antlr/thirdparty/antlr/antlr4-master.zip)
...
if (NOT ANTLR4CPP_GENERATED_SRC_DIR)
  set(ANTLR4CPP_GENERATED_SRC_DIR ${CMAKE_BINARY_DIR}/lib/antlr/antlr4cpp_generated_src)
endif()
